      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <div className="col-span-1 lg:col-span-1">
          ...
          <div className="flex space-x-4">
             <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-emerald-900 flex items-center justify-center hover:bg-emerald-500 hover:text-emerald-950 transition-all shadow-lg" title="Facebook">
             ...
             <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-emerald-900 flex items-center justify-center hover:bg-emerald-500 hover:text-emerald-950 transition-all shadow-lg" title="Instagram">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex items-start space-x-3">
              ...
              <span>123 Legal Square, Downtown, Lahore, Pakistan</span>
            </li>
            ...
            <li className="flex items-center space-x-3">
              ...
              <span>contact@lawbridge.com</span>
            </li>
          </ul>
        </div>
      </div>
